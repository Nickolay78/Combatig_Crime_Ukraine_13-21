#Script for obtaining and cleaning the data from 
#reports of State Court Administration of Ukraine
#Form No 6
...
#Uploading reports from official site
...
#Cleaning data, generation  CSV files
